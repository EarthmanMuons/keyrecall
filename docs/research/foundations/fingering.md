# Scale fingering research

> **Status:** research record. The canonical corpus it produced is live in
> `keyrecall_domain`; this is the evidence behind it.
>
> **Research cutoff:** August 2026.
>
> The **policy** these were chosen under, including the source-quality ladder
> and the cases that took real work, is in
> [`../../decisions/fingering.md`](../../decisions/fingering.md). Sources are
> cited by key into [`../../REFERENCES.md`](../../REFERENCES.md).
...
### Michael Clark, _Piano Basics_ --- Baylor University
...
### Suzanna Sifter, _A Modern Method for Piano Scales_ --- Berklee Press
...
## Fingering patterns, motor families, and technical events
...
## Major-scale canonical fingering
...
## Natural-minor canonical fingering
...
## Harmonic-minor canonical fingering
...
## Fixed-form melodic-minor canonical fingering
...
## Development-time provenance record
...
## A fingering-family diagram, deferred
...
## Modes and later scale families
...
## Arpeggios are a separate taxonomy
...
## Structural observation for the next analysis
